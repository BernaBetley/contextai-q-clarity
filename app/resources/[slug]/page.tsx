  ...
  "what-is-ai-share-of-voice": {
    ...
    sections: [
      ...
      },
      {
        ...
        content:
          "We sample a set of category-relevant questions across multiple LLMs (ChatGPT, Claude, Gemini), track brand appearances, score for prominence and accuracy, and calculate visibility percentages over time. The methodology is transparent and repeatable.",
      },
      {
        heading: "Limitations",
        content:
