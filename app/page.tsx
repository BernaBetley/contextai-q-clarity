...
const phases = [
  {
    ...
    description: "Define 20 strategic questions across brand, category, and use-case intent.",
    output: "Validated question set and success criteria.",
    icon: Search,
  },
  {
    title: "Multi-LLM testing",
    description: "Test questions across ChatGPT, Claude, Gemini, and Perplexity.",
      ...
      <Section className="pt-24 md:pt-32">
        <div className="max-w-4xl">
          ...
          <p className="lead max-w-2xl mb-8">
            Scope: 20 strategic questions. Coverage: ChatGPT, Claude, Gemini, Perplexity. Output: scorecard + roadmap in 5–7
            business days.
          </p>
          <ul className="list-check mb-10 max-w-2xl text-muted-foreground">
            <li>Fixed-scope €500 audit with documented methodology.</li>
            <li>Question-level evidence, not generic SEO claims.</li>
      ...
      <Section className="bg-secondary/30">
        <div className="grid-2-col items-start">
          <div>
            ...
            AI visibility is the share of category-relevant questions where your brand appears and is described accurately in
