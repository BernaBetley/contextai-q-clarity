            ...
            <div className="space-y-10">
              <div>
                ...
                <p className="text-muted-foreground">
                  We collect information you provide when you contact us (e.g., name, email, company, message).
                  If analytics is enabled, we may collect basic usage data (page views and interactions) to understand site performance.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  We do not sell personal data. We may share data with service providers necessary to operate the site
                  (e.g., analytics or form tooling) and only to the extent required.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  We keep personal data only as long as needed to provide services, comply with legal obligations,
                  or resolve disputes.
                </p>
              </div>
