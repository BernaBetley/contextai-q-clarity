          ...
          <div className="max-w-3xl">
            ...
            <div className="space-y-10">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Service details, timelines, and deliverables are defined on the relevant service pages and/or in written agreements.
                  If there is a conflict, the written agreement governs.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  To the maximum extent permitted by law, ContextAI Q will not be liable for indirect, incidental, or consequential
